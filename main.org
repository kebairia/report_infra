...
#+EXPORT_FILE_NAME: pfe_thesis.pdf
#+ARCHIVE:          ~/dox/wrk/pfe/docs/report_infra/report.archive.org
# ---------------------------------------------------------------------
...
:END:
{{{part(Prologue)}}}
This Part contains an introduction to the problem whose solutions this thesis is attempting to discuss,
as well as a clarification of the general structure of the thesis and a brief presentation of its
chapters.
{{{part_end}}}
** Introduction                                                    :ignore:
...
:END:
{{{part(Background)}}}
The second part of this thesis presents definitions of various concepts in computing literature
starting by /acrlong:vss/, moving to /acrlong:iot/, then the Cloud, Edge and Fog computing
{{{part_end}}}
** Chapter 2                                                       :ignore:
:PROPERTIES:
:ID: chp2
:END:
#+include: chps/relevant_theory.org
** Chapter 3                                                       :ignore:
:PROPERTIES:
:ID: chp3
:END:
#+include: chps/our_cont.org
* Part III                                                           :ignore:
:PROPERTIES:
:ALT_TITLE: ii Background
:END:
...
starting by /acrlong:vss/, moving to /acrlong:iot/, then the Cloud, Edge and Fog computing
{{{part_end}}}
#+include: ./chps/future_work.org
#+include: ./chps/cns.org
** Conclusion                                                      :ignore:
:PROPERTIES:
:ID:       cons
:END:
